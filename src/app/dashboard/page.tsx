...
export default async function DashboardPage({
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[70vh] space-y-10 text-center px-4">
        ...
        <div className="space-y-4">
          <h2 className="text-4xl md:text-7xl font-black tracking-tighter uppercase italic bg-gradient-to-b from-white to-white/40 bg-clip-text text-transparent">No Active Analysis</h2>
          <p className="text-muted-foreground max-w-sm mx-auto font-light leading-relaxed text-lg">
            Our diagnostic systems haven't analyzed your career trajectory yet. Initialize a secure scan to begin your survival roadmap.
          </p>
        </div>
        <Link href="/">
  ...
  return <DashboardClient assessment={assessment} />;
}
